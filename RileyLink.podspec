...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/ps2/rileylink_ios.git", :tag => "0.1.1" }
  ...
  s.source_files  = "RileyLink/RileyLinkBLE*.{h,m}", "RileyLink/{MinimedPacket,NSData+Conversion,SendDataTask}.{h,m}"
  # s.exclude_files = "Classes/Exclude"

  s.public_header_files = "RileyLink/RileyLinkBLE*.h"
