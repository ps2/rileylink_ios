...
class TempBasalTests: XCTestCase {
    ...
    func testZeroTempExtraCommand() {
        do {
            ...
            XCTAssertEqual(false, cmd.acknowledgeReminder)
        ...
        // Encode
        let cmd = TempBasalExtraCommand(rate: 0, duration: .hours(0.5), acknowledgeReminder: false, confidenceReminder: true, programReminderInterval: .minutes(60))
    ...
    func testZeroTempThreeHoursExtraCommand() {
        ...
        // Encode
        let cmd = TempBasalExtraCommand(rate: 0, duration: .hours(3), acknowledgeReminder: false, confidenceReminder: true, programReminderInterval: .minutes(60))
    ...
    func testTempBasalExtraCommand() {
        ...
        // Encode
        let cmd = TempBasalExtraCommand(rate: 30, duration: .hours(0.5), acknowledgeReminder: false, confidenceReminder: true, programReminderInterval: .minutes(60))
        XCTAssertEqual("160e7c000bb8000927c00bb8000927c0", cmd.data.hexadecimalString)
    }
    
    func testBasalExtraCommandForOddPulseCountRate() {

        let cmd1 = TempBasalExtraCommand(rate: 0.05, duration: .hours(0.5), acknowledgeReminder: false, confidenceReminder: true, programReminderInterval: .minutes(60))
        XCTAssertEqual("160e7c00000515752a00000515752a00", cmd1.data.hexadecimalString)
        
        let cmd2 = TempBasalExtraCommand(rate: 2.05, duration: .hours(0.5), acknowledgeReminder: false, confidenceReminder: false, programReminderInterval: .minutes(60))
        XCTAssertEqual("160e3c0000cd0085fac700cd0085fac7", cmd2.data.hexadecimalString)

        let cmd3 = TempBasalExtraCommand(rate: 2.10, duration: .hours(0.5), acknowledgeReminder: false, confidenceReminder: false, programReminderInterval: .minutes(60))
        XCTAssertEqual("160e3c0000d20082ca2400d20082ca24", cmd3.data.hexadecimalString)

        let cmd4 = TempBasalExtraCommand(rate: 2.15, duration: .hours(0.5), acknowledgeReminder: false, confidenceReminder: false, programReminderInterval: .minutes(60))
    ...
    func testBasalExtraCommandPulseCount() {
        ...
        let cmd2 = TempBasalExtraCommand(rate: 27.35, duration: .hours(12), acknowledgeReminder: false, confidenceReminder: false, programReminderInterval: 0)
    ...
    func testTempBasalExtraCommandExtremeValues() {
        ...
        // Encode
        let cmd = TempBasalExtraCommand(rate: 30, duration: .hours(12), acknowledgeReminder: false, confidenceReminder: false, programReminderInterval: .minutes(60))
    ...
    func testTempBasalExtraCommandExtremeValues2() {
        ...
        let cmd = TempBasalExtraCommand(rate: 29.95, duration: .hours(12), acknowledgeReminder: false, confidenceReminder: false, programReminderInterval: .minutes(60))
