...
extension RileyLinkDevice: PeripheralManagerDelegate {
    ...
    func peripheralManager(_ manager: PeripheralManager, didUpdateValueFor characteristic: CBCharacteristic) {
        guard let service = RileyLinkServiceUUID(rawValue: characteristic.service.uuid.uuidString) else {
            log.debug("Update from characteristic on unknown service: %@", characteristic.service.uuid.uuidString)
            return
        }
