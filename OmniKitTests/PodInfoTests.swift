...
class PodInfoTests: XCTestCase {
    ...
    func testPodInfoNoFaultAlerts() {
        ...
        do {
            ...
            XCTAssertEqual(.noFaults, decoded.originalLoggedFaultEvent.faultType)
    ...
    func testPodInfoDuringPriming() {
        ...
        do {
            ...
            XCTAssertEqual(0000, decoded.insulinNotDelivered)
            XCTAssertEqual(6, decoded.podMessageCounter)
            XCTAssertEqual(.faultEventSetupPodType8F, decoded.originalLoggedFaultEvent.faultType)
    ...
    func testPodInfoFlashVariables() {
        ...
        do {
            // Decode
            let decoded = try PodInfoFlashVariables(encodedData: Data(hexadecimalString: "")!)
    ...
    func testPodInfoFlashLogRecent() {
        ...
        do {
            // Decode
            let decoded = try PodInfoFlashLog(encodedData: Data(hexadecimalString: "")!)
            XCTAssertEqual(.flashLogFirst50Entries, decoded.podInfoType)
            XCTAssertEqual(134, decoded.numberOfEntries)
            XCTAssertEqual(539, decoded.totalBytes)
            XCTAssertEqual("", decoded.logEntries.hexadecimalString)
        } catch (let error) {
            XCTFail("message decoding threw error: \(error)")
        }
    }
    
    func testPodInfoFlashLogNext() {
        // 02 cb 
        do {
            // Decode
            let decoded = try PodInfoFlashLog(encodedData: Data(hexadecimalString: "")!)
            XCTAssertEqual(.flashLogNext50Entries, decoded.podInfoType)
            XCTAssertEqual(50, decoded.numberOfEntries)
            XCTAssertEqual(203, decoded.totalBytes)
            XCTAssertEqual("", decoded.logEntries.hexadecimalString)
        } catch (let error) {
            XCTFail("message decoding threw error: \(error)")
        }
    }
