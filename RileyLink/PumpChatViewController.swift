...
class PumpChatViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        pumpIdLabel.text = "PumpID: \(device.pumpState?.pumpID ?? "nil")"
    }
    ...
    @IBAction func dumpHistoryButtonPressed(sender: UIButton) {
        ...
        if let ops = device.ops {
            ops.getHistoryEventsSinceDate(oneDayAgo!) { (response) -> Void in
                switch response {
