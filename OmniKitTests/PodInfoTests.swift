...
class PodInfoTests: XCTestCase {
    ...
    func testPodInfoPulseLogRecent() {
       //02 cb 50 0086 34212e00 39203100 3c212d00 41203000 44202c00 49212e00 4c212b00 51202f00 54212c00 59203080 5c202d80 61203080 00212e80 05213180 08202f80 0d203280 10202f80 15213180 18202f80 1d213180 20202e80 25213300 28203200 2d213500 30213100 35213400 38213100 3d203500 40203100 45213300 48203000 4d213200 50212f00 55203300 58203080 5d213280 60202f80 01203080 04202c80 09213180 0c213080 11213280 14203180 19213380 1c203180 21203280 24213200 29203500 2c213100 31213400"
        do {
            ...
            XCTAssertEqual(0x34212e00, decoded.pulseLogEntry[0])
            XCTAssertEqual(0x39203100, decoded.pulseLogEntry[1])
            XCTAssertEqual(0x3c212d00, decoded.pulseLogEntry[2])
            XCTAssertEqual(0x41203000, decoded.pulseLogEntry[3])
            XCTAssertEqual(0x44202c00, decoded.pulseLogEntry[4])
            XCTAssertEqual(0x49212e00, decoded.pulseLogEntry[5])
            XCTAssertEqual(0x4c212b00, decoded.pulseLogEntry[6])
            XCTAssertEqual(0x51202f00, decoded.pulseLogEntry[7])
            XCTAssertEqual(0x54212c00, decoded.pulseLogEntry[8])
            XCTAssertEqual(0x59203080, decoded.pulseLogEntry[9])
            XCTAssertEqual(0x5c202d80, decoded.pulseLogEntry[10])
            XCTAssertEqual(0x61203080, decoded.pulseLogEntry[11])
            XCTAssertEqual(0x00212e80, decoded.pulseLogEntry[12])
            XCTAssertEqual(0x05213180, decoded.pulseLogEntry[13])
            XCTAssertEqual(0x08202f80, decoded.pulseLogEntry[14])
            XCTAssertEqual(0x0d203280, decoded.pulseLogEntry[15])
            XCTAssertEqual(0x10202f80, decoded.pulseLogEntry[16])
            XCTAssertEqual(0x15213180, decoded.pulseLogEntry[17])
            XCTAssertEqual(0x18202f80, decoded.pulseLogEntry[18])
            XCTAssertEqual(0x1d213180, decoded.pulseLogEntry[19])
            XCTAssertEqual(0x20202e80, decoded.pulseLogEntry[20])
            XCTAssertEqual(0x25213300, decoded.pulseLogEntry[21])
            XCTAssertEqual(0x28203200, decoded.pulseLogEntry[22])
            XCTAssertEqual(0x2d213500, decoded.pulseLogEntry[23])
            XCTAssertEqual(0x30213100, decoded.pulseLogEntry[24])
            XCTAssertEqual(0x35213400, decoded.pulseLogEntry[25])
            XCTAssertEqual(0x38213100, decoded.pulseLogEntry[26])
            XCTAssertEqual(0x3d203500, decoded.pulseLogEntry[27])
            XCTAssertEqual(0x40203100, decoded.pulseLogEntry[28])
            XCTAssertEqual(0x45213300, decoded.pulseLogEntry[29])
            XCTAssertEqual(0x48203000, decoded.pulseLogEntry[30])
            XCTAssertEqual(0x4d213200, decoded.pulseLogEntry[31])
            XCTAssertEqual(0x50212f00, decoded.pulseLogEntry[32])
            XCTAssertEqual(0x55203300, decoded.pulseLogEntry[33])
            XCTAssertEqual(0x58203080, decoded.pulseLogEntry[34])
            XCTAssertEqual(0x5d213280, decoded.pulseLogEntry[35])
            XCTAssertEqual(0x60202f80, decoded.pulseLogEntry[36])
            XCTAssertEqual(0x01203080, decoded.pulseLogEntry[37])
            XCTAssertEqual(0x04202c80, decoded.pulseLogEntry[38])
            XCTAssertEqual(0x09213180, decoded.pulseLogEntry[39])
            XCTAssertEqual(0x0c213080, decoded.pulseLogEntry[40])
            XCTAssertEqual(0x11213280, decoded.pulseLogEntry[41])
            XCTAssertEqual(0x14203180, decoded.pulseLogEntry[42])
            XCTAssertEqual(0x19213380, decoded.pulseLogEntry[43])
            XCTAssertEqual(0x1c203180, decoded.pulseLogEntry[44])
            XCTAssertEqual(0x21203280, decoded.pulseLogEntry[45])
            XCTAssertEqual(0x24213200, decoded.pulseLogEntry[46])
            XCTAssertEqual(0x29203500, decoded.pulseLogEntry[47])
            XCTAssertEqual(0x2c213100, decoded.pulseLogEntry[48])
            XCTAssertEqual(0x31213400, decoded.pulseLogEntry[49])
        } catch (let error) {
            XCTFail("message decoding threw error: \(error)")
        }
    }
    ...
    func testPodInfoPulseLogPrevious() {
        ...
        do {
            ...
            XCTAssertEqual(0x14602500, decoded.pulseLogEntry[0])
            XCTAssertEqual(0x19612800, decoded.pulseLogEntry[1])
            XCTAssertEqual(0x1c612400, decoded.pulseLogEntry[2])
            XCTAssertEqual(0x21612800, decoded.pulseLogEntry[3])
            XCTAssertEqual(0x24612500, decoded.pulseLogEntry[4])
            XCTAssertEqual(0x29612900, decoded.pulseLogEntry[5])
            XCTAssertEqual(0x2c602600, decoded.pulseLogEntry[6])
            XCTAssertEqual(0x31602a00, decoded.pulseLogEntry[7])
            XCTAssertEqual(0x34602600, decoded.pulseLogEntry[8])
            XCTAssertEqual(0x39612a80, decoded.pulseLogEntry[9])
            XCTAssertEqual(0x3c612680, decoded.pulseLogEntry[10])
            XCTAssertEqual(0x41602c80, decoded.pulseLogEntry[11])
            XCTAssertEqual(0x00602780, decoded.pulseLogEntry[12])
            XCTAssertEqual(0x05632880, decoded.pulseLogEntry[13])
            XCTAssertEqual(0x08602580, decoded.pulseLogEntry[14])
            XCTAssertEqual(0x0d612880, decoded.pulseLogEntry[15])
            XCTAssertEqual(0x10612580, decoded.pulseLogEntry[16])
            XCTAssertEqual(0x15612780, decoded.pulseLogEntry[17])
            XCTAssertEqual(0x18602380, decoded.pulseLogEntry[18])
            XCTAssertEqual(0x1d602680, decoded.pulseLogEntry[19])
            XCTAssertEqual(0x20612280, decoded.pulseLogEntry[20])
            XCTAssertEqual(0x25602700, decoded.pulseLogEntry[21])
            XCTAssertEqual(0x28612400, decoded.pulseLogEntry[22])
            XCTAssertEqual(0x2d212800, decoded.pulseLogEntry[23])
            XCTAssertEqual(0x30202700, decoded.pulseLogEntry[24])
            XCTAssertEqual(0x35202a00, decoded.pulseLogEntry[25])
            XCTAssertEqual(0x38202700, decoded.pulseLogEntry[26])
            XCTAssertEqual(0x3d202a00, decoded.pulseLogEntry[27])
            XCTAssertEqual(0x40202900, decoded.pulseLogEntry[28])
            XCTAssertEqual(0x45202c00, decoded.pulseLogEntry[29])
            XCTAssertEqual(0x48202a00, decoded.pulseLogEntry[30])
            XCTAssertEqual(0x4d212c00, decoded.pulseLogEntry[31])
            XCTAssertEqual(0x50212900, decoded.pulseLogEntry[32])
            XCTAssertEqual(0x55212c00, decoded.pulseLogEntry[33])
            XCTAssertEqual(0x58212980, decoded.pulseLogEntry[34])
            XCTAssertEqual(0x5d202b80, decoded.pulseLogEntry[35])
            XCTAssertEqual(0x60202880, decoded.pulseLogEntry[36])
            XCTAssertEqual(0x01202d80, decoded.pulseLogEntry[37])
            XCTAssertEqual(0x04212a80, decoded.pulseLogEntry[38])
            XCTAssertEqual(0x09202d80, decoded.pulseLogEntry[39])
            XCTAssertEqual(0x0c212980, decoded.pulseLogEntry[40])
            XCTAssertEqual(0x11212a80, decoded.pulseLogEntry[41])
            XCTAssertEqual(0x14212980, decoded.pulseLogEntry[42])
            XCTAssertEqual(0x1921801c, decoded.pulseLogEntry[43])
            XCTAssertEqual(0x212a8021, decoded.pulseLogEntry[44])
            XCTAssertEqual(0x212c8024, decoded.pulseLogEntry[45])
            XCTAssertEqual(0x202c0029, decoded.pulseLogEntry[46])
            XCTAssertEqual(0x212f002c, decoded.pulseLogEntry[47])
            XCTAssertEqual(0x212d0031, decoded.pulseLogEntry[48])
            XCTAssertEqual(0x20310082, decoded.pulseLogEntry[49])
        } catch (let error) {
            XCTFail("message decoding threw error: \(error)")
        }
    }
