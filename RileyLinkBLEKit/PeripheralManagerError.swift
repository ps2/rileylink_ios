...
extension PeripheralManagerError: LocalizedError {
    public var errorDescription: String? {
        ...
        case .notReady:
            return LocalizedString("The RileyLink is not connected", comment: "Not ready error description")
        case .timeout:
            return LocalizedString("The RileyLink did not respond in time", comment: "Timeout error description")
        case .unknownCharacteristic:
