...
class MinimedPumpManagerTests: XCTestCase {
    ...
    func testPendingDoseUpdatesWithActualDeliveryFromHistoryDose() {
        ...
        let unfinalizedBolus = UnfinalizedDose(bolusAmount: 5.4, startTime: bolusTime, duration: TimeInterval(200), insulinType: .novolog, isReconciledWithHistory: false)
    ...
    func testReconciledDosesShouldOnlyAppearInReturnedPendingDoses() {
        ...
        let unfinalizedBolus = UnfinalizedDose(bolusAmount: bolusAmount, startTime: bolusTime, duration: bolusDuration, insulinType: .novolog, isReconciledWithHistory: false)
